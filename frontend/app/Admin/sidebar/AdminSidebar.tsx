          ...
          >
            {!isCollapsed && (
              ...
              >
                <Link
                  href="/"
                  className="self-center whitespace-nowrap text-sm sm:text-xl font-semibold text-black blog-title font-[Poppins]   italic"
                >
                  <span className="px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white font-bold italic">
                    Sticky
                  </span>
                  Learning
                </Link>
